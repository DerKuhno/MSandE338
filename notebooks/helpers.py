...
def plot_relearning_curves(steps, vanilla_ppl, standard_unlearn_ppl, undo_ppl):
    ...
    plt.plot(steps, undo_ppl, label="UNDO Framework (Strong/Traces Erased)", color="green", linewidth=2)
